...
class HelpWindowsMixin:
    ...
    def render_controls_window(self):
        ...
        if expanded:            
            ...
            imgui.spacing()
            imgui.text("Controller / Steam Deck")
            imgui.separator()
            imgui.bullet_text("Left stick - Move camera")
            imgui.bullet_text("Right stick up/down or triggers - Zoom")
            imgui.bullet_text("Right bumper - Fast movement / zoom")
            imgui.bullet_text("A - Pause/resume simulation")
            imgui.bullet_text("B - Reset particles")
            imgui.bullet_text("X - Toggle sidebar")
            imgui.bullet_text("Y - Randomize mutation seed")
            imgui.bullet_text("Select - Toggle mouse mode")
            imgui.bullet_text("Start - Reset controller field camera")
