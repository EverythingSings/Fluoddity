...
class PreferencesState:
    ...
    tracer_colored_extinction: bool = False
    ...
    tracer_emission_strength: float = 0.0  # emission intensity (0 = off)
    ...
    three_d_optix_capture_width: int = 0  # Offline PT width; 0 follows the framebuffer
    three_d_optix_capture_height: int = 0  # Offline PT height; 0 follows the framebuffer
